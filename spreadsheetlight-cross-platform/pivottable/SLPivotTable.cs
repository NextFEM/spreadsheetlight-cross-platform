...
public class SLPivotTable
{
	...
	/// <summary>
	/// Adds a field to the Filters section of the PivotTable.
	/// </summary>
	/// <param name="FieldIndex">The numeric identifier for the field to add.</param>
	public void SetFilterField(int FieldIndex)
	{
		SLPivotFieldType pft = new()
		{
			IsNumericIndex = true,
			FieldIndex = FieldIndex,
			FieldType = SLPivotFieldTypeValues.Filter
		};
	...
	/// Adds a field to the Filters section of the PivotTable.
	/// </summary>
	/// <param name="FieldName">The text identifier for the field to add.</param>
	...
	/// <summary>
	/// Adds a field to the Columns section of the PivotTable.
	/// </summary>
	/// <param name="FieldIndex">The numeric identifier for the field to add.</param>
	public void SetColumnField(int FieldIndex)
	{
		SLPivotFieldType pft = new()
		{
			IsNumericIndex = true,
			FieldIndex = FieldIndex,
			FieldType = SLPivotFieldTypeValues.Column
		};
		this.FieldSettingInstructions.Add(pft);
	}
	...
	/// <summary>
	/// Adds a field to the Rows section of the PivotTable.
	/// </summary>
	/// <param name="FieldIndex">The numeric identifier for the field to add.</param>
	public void SetRowField(int FieldIndex)
	{
		SLPivotFieldType pft = new()
		{
			IsNumericIndex = true,
			FieldIndex = FieldIndex,
			FieldType = SLPivotFieldTypeValues.Row
		};
		this.FieldSettingInstructions.Add(pft);
	}
	...
	/// <summary>
	/// Adds a field to the Values section of the PivotTable.
	/// </summary>
	/// <param name="FieldIndex">The numeric identifier for the field to add.</param>
	public void SetValueField(int FieldIndex)
	{
		SLPivotFieldType pft = new()
		{
			IsNumericIndex = true,
			FieldIndex = FieldIndex,
			FieldType = SLPivotFieldTypeValues.Value
		};
		this.FieldSettingInstructions.Add(pft);
	}
